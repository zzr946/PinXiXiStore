...
<head>
  ...
  <!-- 个人中心样式 -->
		...
		<link href="res/static/one/css/stepstyle.css" rel="stylesheet" type="text/css">
        ...
        <div class="center">
			<div class="col-main" style="">
				<div class="main-wrap" style="background-color: rgba(255,255,255,0.9);">
					...
					<form action="user" class="am-form am-form-horizontal" method="get">
					<!-- 隐藏域用来区分是什么操作 -->
					<input type="hidden" id="hiddenmethod" name="method" value="modifypwd">
						<div class="am-form-group">
							<label for="user-old-password" class="am-form-label">原密码</label>
							<div class="am-form-content">
								<input type="password" name="oldpwd" id="user-old-password" placeholder="请输入原登录密码">
							</div>
						</div>
						<div class="am-form-group">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="password" name="renewpwd" id="user-confirm-password" placeholder="请再次输入上面的密码">
							</div>
						</div>
						<div class="info-btn">
							<button type="button" class="am-btn am-btn-danger" onclick="sub()">保存修改</button>
						</div>
						<script type="text/javascript">
							function sub(){
								//获取当前登录的用户id
								...
								//获取确认新密码
								var renewpwd=$('#user-confirm-password').val();
								console.info(method);
								//console.info(oldpwd);
								//console.info(newpwd);
								//console.info(renewpwd);
								var ok=true;
								...
								if(ok){
									$.get('user',{method:method,uid:id,oldpwd:oldpwd,newpwd:newpwd},function(result){

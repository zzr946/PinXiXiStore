...
//   	})
  ...
  <div class="content content-nav-base about-content">
    ...
    <div class="brief-content layui-clear w1200">
      ...
      <div class="text">
        <p>拼XiXi以网上在线销售的方式，为各位用户提供一个私家商城，让您足不出户，体验逛商场的快感，再也不用担心因为逛街而腿疼了。拼XiXi致力于为用户带来便捷、安全、放心的购物体验。</p>
      </div>
    </div>
    <div class="banner-text">
      <div class="w1200">
        <p>拼XiXi商城在售商品种类繁多，价格实惠，拼XiXi商城以出厂价为用户带来优质体验，我们保证价格实惠，货源正规，服务周到，若因我们的服务问题给您带来困惑，请联系我们，我们定会给您一个满意的答复。</p>
      </div>
    </div>

      ...
      <div class="inner-cont0">
        <div class="inner-cont1 w1200">
          <div class="inner-cont2">
            <a href="goods?method=productall" class="active">所有商品</a>
      ...
      <div class="commod-cont w1200 layui-clear">
        <div class="left-nav">
          ...
          <div class="list-box">
            <dl>
             <dt>精品服饰</dt>
             <dd><a href="goods?method=goodsbytitle&title=男士上装">男士上装</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=女士上装">女士上装</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=男士下装">男士下装</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=女士下装">女士下装</a></dd>
            </dl>
            <dl>
             <dt>家居家纺</dt>
             <dd><a href="goods?method=goodsbytitle&title=床上用品">床上用品</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=收纳用品">收纳用品</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=水具酒具">水具酒具</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=厨房配件">厨房配件</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=餐具">餐具</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=生活日用">生活日用</a></dd>
            </dl>
            <dl>
             <dt>食品生鲜</dt>
             <dd><a href="goods?method=goodsbytitle&title=休闲食品">休闲食品</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=进口食品">进口食品</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=新鲜水果">新鲜水果</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=精选肉类">精选肉类</a></dd>
            </dl>
            <dl>
             <dt>母婴童装</dt>
             <dd><a href="goods?method=goodsbytitle&title=营养辅食">营养辅食</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=婴童寝居">婴童寝居</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=喂养用品">喂养用品</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=洗护用品">洗护用品</a></dd>
            </dl>
            <dl>
             <dt>运动户外</dt>
             <dd><a href="goods?method=goodsbytitle&title=户外鞋服">户外鞋服</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=运动套装">运动套装</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=户外装备">户外装备</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=体育器材">体育器材</a></dd>
            </dl>
            
            <dl>
             <dt>箱包手袋</dt>
             <dd><a href="goods?method=goodsbytitle&title=精品包包">精品包包</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=功能箱包">功能箱包</a></dd>
            </dl>
            <dl>
             <dt>美妆护肤</dt>
             <dd><a href="goods?method=goodsbytitle&title=面部护理">面部护理</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=香水">香水</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=彩妆">彩妆</a></dd>
            </dl>
            <dl>
             <dt>图书文娱</dt>
             <dd><a href="goods?method=goodsbytitle&title=图书">图书</a></dd>
             <dd><a href="goods?method=goodsbytitle&title=文娱音像">文娱音像</a></dd>
            </dl>
            ...
            <div class="cont-list layui-clear" id="list-cont">
            	...
            	<script type="text/javascript">
            			function choose(t){
            				//获取当前用户的id
            				var uid=$('#uid').val();
            				console.info("当前登录的用户id:"+uid);
            				//获取该商品的id
            				var $gid=$(t).parent().prev().prev().prev().prev().prev().prev();
            				var gid=$gid[0].value;
            				console.info("商品id:"+gid);
            				//获取该商品的编号
            				var $goodsnumber=$(t).parent().prev().prev().prev().prev().prev();
            				var goodsnumber=$goodsnumber[0].value;
            				console.info("商品编号:"+goodsnumber)
            				//获取该商品的库存
            				var $goodstotal=$(t).parent().prev().prev().prev().prev();
            				var goodstotal=$goodstotal[0].value;
            				console.info("库存:"+goodstotal);
            				//获取该商品的商家id
            				var $goodstotal=$(t).parent().prev().prev().prev();
            				var goodstotal=$goodstotal[0].value;
            				console.info("商家id:"+goodstotal);
            				//获取商品简介
            				var $goodsinfo=$(t).parent().prev().prev();
            				var goodsinfo=$goodsinfo[0].value;
            				console.info("商品简介:"+goodsinfo)
            				//获取该商品的促销价
            				var $discountprice=$(t).parent().prev();
            				var discountprice=$discountprice[0].value;
            				console.info("促销价:"+discountprice);
            				//获取商品图片
            				var $goodsimage=$(t).children();
            				var goodsimage=$goodsimage[0].src;
            				console.info("商品图片:"+goodsimage);
            				//获取该商品的名称
            				var $text=$(t).parent().next().children();
            				var goodsname=$($text[0]).text();
            				console.info("商品名称:"+goodsname);
            				//获取商品价格
            				var $goodsprice=$(t).parent().next().children();
            				var goodsprice=$($($goodsprice[1]).children()[0]).text();
            				goodsprice=goodsprice.substring(1,goodsprice.length);
            				console.info("商品价格:"+goodsprice);
            				//获取商品销量goodssell
            				var $goodssell=$(t).parent().next().children();
            				var goodssell=$($($goodsprice[1]).children()[1]).text();
            				goodssell=goodssell.substring(0,goodssell.length-2);
            				console.info("销量:"+goodssell);
            	...
            	<c:forEach var="product" items="${productall}" varStatus="s">
            		<div class="item">
            			<input type="hidden" id="hiddengid" value="${product.gid}"><!-- 商品id -->
						<input type="hidden" id="hiddengoodsnumber" value="${product.goodsnumber}"><!-- 商品编号 -->
						<input type="hidden" id="hiddengoodstotal" value="${product.goodstotal}"><!-- 商品库存 -->
						<input type="hidden" id="hiddenmid" value="${product.mid}"><!-- 商家id -->
						<input type="hidden" id="hiddengoodsinfo" value="${product.goodsinfo}"><!-- 商品简介 -->
						<input type="hidden" id="hiddendiscountprice" value="${product.discountprice}"><!-- 商品促销价 -->
		                <div class="img"><!-- 商品图片 -->
		                  <a onclick="choose(this)" href="javascript:;"><img src="/userphoto/${product.goodsimage}" width="280px" height="280px"></a>
		                </div>
		                <div class="text">
		                  <p class="title">${product.goodsname}</p><!-- 商品名称 -->
		                  <p class="price">
		                    <span class="pri">￥${product.goodsprice}</span><!-- 商品价格 -->
		                    <span class="nub">${product.goodssell}付款</span><!-- 商品销量 -->
		                  </p>
		                </div>
		              </div>
            	</c:forEach>
...
<!--               </div> -->
            ...
            <script type="text/javascript">
            	...
            	//获取当前页数
            	var current=getUrlSearch("current");
            	$(function(){
					if((eval(current))<=1){//如果是第一页则将上一页的按钮禁用
						//console.info($('#prevpage'))
						$('#prevpage').addClass('am-disabled');
					}
					//如果没有商品则将下一页按钮禁用
					if(getUrlSearch('notgoods')=='0'){
						layer.alert('没有更多商品了...');
					...
					function nextpage(){/*************点击下一页的方法******************/
	            		//获取当前页
	            		current=getUrlSearch("current");
						current++;//页数++
						//alert("需要查询的页数:"+current);
						//默认查出来的所有商品分页
						location.href="goods?method=commpaging&current="+current;
	            	}
					
					function prevpage(){/*************点击上一页的方法******************/
						//获取当前页
	            		current=getUrlSearch("current");
						current--;//页数--
						//默认查出来的所有商品分页
				...
				<ul class="am-pagination am-pagination-right">
					<!-- class="am-disabled"表示禁用 -->
					<li class="" id="prevpage" style="width: 90px"><a href="javascript:void(0)" onclick="prevpage()">&laquo;上一页</a></li>
					
					<li class="" id="nextpage" style="width: 80px"><a href="javascript:void(0)" onclick="nextpage()">下一页&raquo;</a></li>
				</ul>

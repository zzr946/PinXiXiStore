...
<body>
	...
	<input type="hidden" name="method" value="forgetpwd">
		<dl class="admin_reg">
			 <dt>
			 ...
			 <dd class="pwd_icon">
			  <input type="password" name="new_password" lay-verify="required" lay-reqtext="密码不能为空" placeholder="请输入新密码" class="login_txtbx"/>
			 </dd>
			 <dd class="val_icon">
			  <div class="checkcode">
			 ...
			 <dd>
			  <input type="submit" value="确认修改" class="submit_btn_reg" lay-submit="" onclick="reg_btn();"/>
			 </dd>
			  <dd>

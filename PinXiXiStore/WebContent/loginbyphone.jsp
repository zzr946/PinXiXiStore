    ...
    <div class="login-bg">
      <div class="login-cont w1200">
        <div class="form-box">
          ...
          <!-- 隐藏域用于区分是什么操作 -->
          <input type="hidden" name="method" value="user_loginByPhone">
            <legend>手机号登录</legend>
            ...
            <div class="layui-form-item login-btn">
              <div class="layui-input-block">
                <button class="layui-btn" id="log_btn" lay-submit="" lay-filter="demo1">登录</button>
              </div>
              <script type="text/javascript">
              	$(function(){
              		//验证码输入错误
